...
for i,line in enumerate(['Stock legs, motors, camera and head module are retained.', 'Cheek clearance holes: diameter 2.4 mm. Screws: prototype M2.', 'Head bridge bosses meet inner cheek faces at Y = +/-44 mm.', 'Tail saddle slots: 3 x 17 mm; strap mount requires trial fitting.', 'Teeth/eyebrows are bonded decorative parts; no biting mechanism.', 'Tail segments are reference parts: joint bonding/fit is unverified.', 'Arm brackets use M2 clearance and a 3 x 4 mm strap channel.', 'CAD coordinates use the source MJCF reference pose, not print-bed origin.']):c.drawString(45,160-i*16,line)
footer(1);c.showPage()
